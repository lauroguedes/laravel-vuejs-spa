    ...
    <div class="aside-content h-100">
        <el-menu
            ...
            <el-submenu index="1">
                ...
                <el-menu-item :route="{name: 'page-one'}" index="1-1">Example Page 1</el-menu-item>
                <el-menu-item :route="{name: 'page-two'}" index="1-2">Example Page 2</el-menu-item>
                <el-menu-item :route="{name: 'page-three'}" index="1-3">Example Page 3</el-menu-item>
            </el-submenu>
            <el-submenu index="2">
                <template slot="title">
